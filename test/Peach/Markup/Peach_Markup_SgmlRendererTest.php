...
class Peach_Markup_SgmlRendererTest extends Peach_Markup_AbstractRendererTest
{
     ...
     * 以下を確認します.
     * 
     * - 返り値が Peach_Markup_SgmlRenderer のインスタンスである
     * - どの返り値も, 同一のインスタンスを返す
     * 
    ...
    {
        $obj1 = Peach_Markup_SgmlRenderer::getInstance();
        $obj2 = Peach_Markup_SgmlRenderer::getInstance();
        $this->assertSame("Peach_Markup_SgmlRenderer", get_class($obj1));
     ...
     * 空要素タグの出力をテストします.
     * 
     * @covers Peach_Markup_SgmlRenderer::formatEmptyTag
     * @covers Peach_Markup_SgmlRenderer::formatEmptyTagSuffix
     * @covers Peach_Markup_AbstractRenderer::formatTagPrefix
     */
    ...
    /**
     * 終了タグの出力をテストします.
     * @covers Peach_Markup_SgmlRenderer::formatEndTag
     */
     ...
     * 開始タグの出力をテストします.
     * 
     * @covers Peach_Markup_SgmlRenderer::formatStartTag
     * @covers Peach_Markup_SgmlRenderer::formatAttribute
     * @covers Peach_Markup_SgmlRenderer::formatBooleanAttribute
     */
